...
namespace learning_to_fly{
    namespace config{
        ...
        struct Validation: T_SUPER_CONFIG{
            ...
            rlt::rl::utils::validation::set::Component<rlt::rl::utils::validation::metrics::MaxErrorMean<rlt::rl::utils::validation::metrics::multirotor::ANGULAR_ACCELERATION, TI,   0>,
            rlt::rl::utils::validation::set::Component<rlt::rl::utils::validation::metrics::MaxErrorStd <rlt::rl::utils::validation::metrics::multirotor::ANGULAR_ACCELERATION, TI,   0>,
